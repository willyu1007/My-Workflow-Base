...
| Aggregate source is exact and portable | Source-lock verification | passed | 2026-09-17 aggregate hash `dd888b89f89d4137fb717bba60a400f9f68bb127b4485121270f1c8eb9ea51e7` after the batch-execution-control retirement (identical to the pre-batch lock). |
